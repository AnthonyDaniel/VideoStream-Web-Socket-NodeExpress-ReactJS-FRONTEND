...
app.use(compression());
app.use(express.static(path.join(__dirname, '/functions/build')));
app.use((req, res) => res.sendFile(__dirname + '/functions/build/index.html'));
app.use(favicon('./functions/build/favicon.ico'));
